...
//i2s sample rate
#define EXAMPLE_I2S_SAMPLE_RATE   (64000)
//(16000)
//i2s data bits
...
void example_i2s_adc_dac(void*arg)
{
    ...
    while (1) {
        ...
        for (int rd_offset = 0; rd_offset < flash_wr_size; rd_offset += FLASH_SECTOR_SIZE) {
            ...
            //send data
            i2s_write(EXAMPLE_I2S_NUM, (char*) i2s_write_buff, FLASH_SECTOR_SIZE, &bytes_written, portMAX_DELAY);
